...
class DistributionsController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.html
      format.csv do
        send_data Exports::ExportDistributionsCSVService.new(distributions: @distributions, filters: filter_params, current_organization: current_organization).generate_csv, filename: "Distributions-#{Time.zone.today}.csv"
      end
    end
  end
